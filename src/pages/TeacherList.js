...
export default function TeacherList() {
  ...
  const handleSelectAll = () => {
    const currentEvents = teacherSchedules[selectedTeacher.id] || [];
          ...
          <div>
            <div style={{ 
              ...
              <p style={{ 
                ...
                Select a teacher to view and manage their schedule
              </p>
            </div>
          ...
          <div>
              ...
              <div style={{ 
                ...
                <div style={{ 
                  ...
                  {showCheckboxes && (
                    ...
                    >
                      {selectedEvents.size === (teacherSchedules[selectedTeacher.id]?.filter(e => !e.isClass).length || 0)
                        ? "Unselect All"
                        : "Select All"}
                    </HoverButton>
                  )}
            ...
            <div style={{
              ...
              <div style={{
                ...
                {teacherSchedules[selectedTeacher.id] && (() => {
                  const overlaps = checkEventOverlaps(teacherSchedules[selectedTeacher.id]);
